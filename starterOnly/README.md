...
![Test de validation HTML W3C](./supply/w3c_validation.png)
...
![Les champs de type 'text'](./supply/type_text.png)
...
![Les champs de type 'select'](./supply/type_select.png)
...
![Première branche de travail](./supply/kraken-1.png)

### 1.3.2. Branche dédiée au développement du formulaire

![Deuxième branche de travail](./supply/kraken-2.png)

### 1.3.3. Branche dédiée à la mise en page et au responsive

![Troisième branche de travail](./supply/kraken-3.png)
